    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btntime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(electrician.this,
        ...
        btndate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(electrician.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        appointmentref.push().setValue(appointment).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(electrician.this, "Appointment Has booked", Toast.LENGTH_SHORT).show();
                    Intent i = new Intent(electrician.this, AppointmentBooked.class);
                    startActivity(i);
                    finish();
                }else {
                    Toast.makeText(electrician.this, "please try again later...", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
